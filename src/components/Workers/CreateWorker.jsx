...
export default function CreateWorker() {
  ...
  const handleCheckChangePermission0 = (e) => {
    if (e.target.id !== "watchSubs") {
      ...
      newState.permissions[e.target.id] = !values.permissions[e.target.id];
      setValues({ ...newState });
    } else {
  ...
  const handleSubmit = async (event) => {
    ...
    if (data.success) {
      dispatch(popupIsOn("Congrats, User created successfully!"));
          ...
          <div className={styles.subscriptionPermission}>
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="watchSubs"
                checked={values.permissions.watchSubs}
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="createSubs"
                checked={values.permissions.createSubs}
                onChange={handleCheckChangePermission0}
              />
              <label
                htmlFor="createSubs"
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="updateSubs"
                checked={values.permissions.updateSubs}
                onChange={handleCheckChangePermission0}
              />
              <label
                htmlFor="updateSubs"
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="deleteSubs"
                checked={values.permissions.deleteSubs}
                onChange={handleCheckChangePermission0}
              />
              <label
                htmlFor="deleteSubs"
          ...
          <div className={styles.moviesPermission}>
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="watchMovies"
                checked={values.permissions.watchMovies}
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="createMovies"
                checked={values.permissions.createMovies}
                onChange={handleCheckChangePermission1}
              />
              <label
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="updateMovies"
                checked={values.permissions.updateMovies}
                onChange={handleCheckChangePermission1}
              />
              <label
            ...
            <div className={styles.formCheckBoxGroup}>
              <input
                type="checkbox"
                id="deleteMovies"
                checked={values.permissions.deleteMovies}
                onChange={handleCheckChangePermission1}
              />
              <label
